...
export default function MainPage() {
  ...
  return (
    <>
      ...
      <div
        className="position-sticky top-0 d-flex justify-content-between align-items-center border bg-light z-1">
          ...
          <div>
            <ButtonMui className="me-1">
              <p className="m-0 p-0">Your Profile</p>
            </ButtonMui>
          </div>
